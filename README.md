# owf-data-co-water-projects #

This repository contains the [Open Water Foundation (OWF)](https://openwaterfoundation.org)
dataset files for Colorado water projects, focusing on infrastructure projects in the Poudre Basin.
This dataset can be expanded to other areas.

Currently this dataset is simple and does not correspond to State of Colorado Water Plan or
Basin Implementation Plan projects.
...
---------------- above folders are recommended --------------------
        ...
        owf-data-co-water-projects/         This repository.
...
[Colorado Farms](https://data.openwaterfoundation.org/state/co/owf/water-projects/) dataset links.
